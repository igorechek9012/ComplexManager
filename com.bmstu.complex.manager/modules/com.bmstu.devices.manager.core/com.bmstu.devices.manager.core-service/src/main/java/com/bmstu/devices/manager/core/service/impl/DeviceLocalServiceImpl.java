...
public class DeviceLocalServiceImpl extends DeviceLocalServiceBaseImpl {
	...
	@Override
	public Device addDevice(long userId, String name, String uniqueId, long geozoneId, String group, String phoneNumber, String model, String contact,

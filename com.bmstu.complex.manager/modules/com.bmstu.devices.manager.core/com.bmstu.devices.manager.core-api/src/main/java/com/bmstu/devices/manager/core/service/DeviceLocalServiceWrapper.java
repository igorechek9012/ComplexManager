...
public class DeviceLocalServiceWrapper implements DeviceLocalService,
	...
	*/
	...
	public com.bmstu.devices.manager.core.model.Device addDevice(long userId,
		java.lang.String name, java.lang.String uniqueId, long geozoneId,
		...
		return _deviceLocalService.addDevice(userId, name, uniqueId, geozoneId,
			group, phoneNumber, model, contact, category, deviceAttributes,
			serviceContext);
	}

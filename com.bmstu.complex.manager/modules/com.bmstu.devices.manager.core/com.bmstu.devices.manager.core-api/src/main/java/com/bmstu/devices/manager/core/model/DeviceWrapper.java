...
public class DeviceWrapper implements Device, ModelWrapper<Device> {
	...
	*/
	...
	/**
	* Returns the geozone ID of this device.
	*
	* @return the geozone ID of this device
	*/
	@Override
	public long getGeozoneId() {
		return _device.getGeozoneId();
	}
	...
	*/
	...
	/**
	* Sets the geozone ID of this device.
	*
	* @param geozoneId the geozone ID of this device
	*/
	@Override
	public void setGeozoneId(long geozoneId) {
		_device.setGeozoneId(geozoneId);
	}
